...
class m260720_150000_rename_trigger_condition_to_cart_condition extends Migration
{
	...
	public function safeUp(): bool
	{
		...
		$this->_remapStoredClasses(self::OLD_AND_CONDITION_CLASS, AndCondition::class);
	...
	public function safeDown(): bool
	{
		if ($this->db->tableExists(Discount::TABLE_NAME)) {
			$this->_remapStoredClasses(AndCondition::class, self::OLD_AND_CONDITION_CLASS);
	...
	/**
	 * AndCondition (formerly AndTriggerCondition) is used both as the discount's
